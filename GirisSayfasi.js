...
//menus
const oturumAcMenu = document.getElementById("oturum-ac-menu");
const oturumAcMenuContent = document.getElementById("oturum-ac-menu-content");
oturumAcMenuContent.style.color = "#fff";

oturumAcMenu.addEventListener("mouseover", ()=> {
    oturumAcMenu.style.backgroundColor = "#fff";
    oturumAcMenuContent.style.color = "#000";
})

oturumAcMenu.addEventListener("mouseout", () => {
    oturumAcMenu.style.backgroundColor = "#000";
    oturumAcMenuContent.style.color = "#fff";
})
